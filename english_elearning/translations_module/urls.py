...
from views import DictionaryView, ProfileView, PasswordView, QuizMainView, EmailSuggestions
...
urlpatterns = [
    ...
    url(r'^suggestion/?$', login_required(EmailSuggestions.as_view()), name='Suggestion'),
